...
# Route RouteRoute RouteRoute RouteRoute RouteRoute RouteRoute Route

# 초기 메인 페이지. QR코드를 찍는 위치, 이름, 전화번호를 입력 받음
@ app.route('/')
def main_get(loc=None, name=None, phone=None):
...
def new_transaction():
    ...
    # Create a new Transaction
    index = blockchain.new_transaction(
        values['location'], values['name'], values['phone'])
